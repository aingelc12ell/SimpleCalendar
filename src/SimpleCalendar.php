...
class SimpleCalendar {
    ...
    /**
     * Fetch the actual date set as today for this calendar
     * @return \DateTimeInterface|null
     */
    ...
    /**
     * @param \DateTimeInterface|int|string     $date   Date string for the event
     * @param string                            $html   Raw HTML for the event
     * @return void
     */
    ...
    /**
     * Retrieve the series of day contents
     * @return array
     */
    ...
    public function render() {
        ...
        for( $i = 1; $i <= $daysInMonth; $i++ ) {
            ...
            $out .= '<td class="' . ($isToday ? $this->classes['today'] . ' ' : '') . 'calendarday" thisday="' . $date->format('Ymd') . '">';
